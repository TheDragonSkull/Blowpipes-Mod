...
public class BlowPipeMod {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.COMBAT) {
            ...
            event.insertAfter(PotionContents.createItemStack(Items.TIPPED_ARROW, ModPotions.BLEED_POTION),
        ...
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            ...
            event.insertAfter(Items.ELYTRA.getDefaultInstance(),
        ...
        if (event.getTabKey() == CreativeModeTabs.FUNCTIONAL_BLOCKS) {
            event.insertAfter(Blocks.SMITHING_TABLE.asItem().getDefaultInstance(),
                    ModBlocks.DART_TABLE.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.insertAfter(ModBlocks.DART_TABLE.get().asItem().getDefaultInstance(),
                    ModBlocks.BLOWPIPE_GROUND_STAND.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.insertAfter(ModBlocks.BLOWPIPE_GROUND_STAND.get().asItem().getDefaultInstance(),
                    ModBlocks.BLOWPIPE_WALL_STAND.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.insertAfter(ModBlocks.BLOWPIPE_WALL_STAND.get().asItem().getDefaultInstance(),
                    ModBlocks.DART_STAND.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }

        if (event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            event.insertAfter(Items.BLAZE_ROD.asItem().getDefaultInstance(),
                    ModItems.NETHERITE_ROD.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }

        if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) {
            event.insertAfter(PotionContents.createItemStack(Items.POTION, ModPotions.BLEED_POTION),
                    new ItemStack(ModItems.CHARMING_AURA_POTION.get()),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);

            event.insertAfter(PotionContents.createItemStack(Items.SPLASH_POTION, ModPotions.BLEED_POTION),
                    new ItemStack(ModItems.CHARMING_AURA_SPLASH_POTION.get()),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);

            event.insertAfter(PotionContents.createItemStack(Items.LINGERING_POTION, ModPotions.BLEED_POTION),
