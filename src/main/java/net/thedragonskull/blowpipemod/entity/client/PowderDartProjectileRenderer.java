...
public class PowderDartProjectileRenderer extends EntityRenderer<PowderDartProjectileEntity> {
    private final EntityRendererProvider.Context context;

    public PowderDartProjectileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.context = pContext;
    }

    @Override
    public void render(PowderDartProjectileEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
        ...
        ItemStack stack = new ItemStack(ModItems.POWDER_DART.get());
    ...
    @Override
    public ResourceLocation getTextureLocation(PowderDartProjectileEntity pEntity) {
        return null;
    }
}
